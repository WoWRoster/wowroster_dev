 ...
 * @version    SVN: $Id: apiitem.php 2355 2011-09-15 23:37:58Z ulminia@gmail.com $
...
/*
	...
	function _getSocketBonus()
	{
		if( isset($this->attributes['SocketBonus']) )
		{
			...
			{
				$html = 'Socket Bonus: <span style="color:#00ff00;">' . $this->attributes['SocketBonus'] . '</span><br />';
			}
			else
			{
				$html = 'Socket Bonus: <span style="color:#9d9d9d;">' . $this->attributes['SocketBonus'] . '</span><br />';
			}
