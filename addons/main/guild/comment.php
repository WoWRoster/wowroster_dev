 ...
 * @version    SVN: $Id: comment.php 2393 2012-02-15 19:56:10Z ulminia@gmail.com $
...
{
	$news['text'] = nl2br(htmlentities($news['text']));
}
...
$roster->tpl->assign_vars(array(
	...
	'U_ADD_NEWS'  => makelink('guild-main-add'),
...
$roster->tpl->assign_block_vars('news_row', array(
	...
	'U_COMMENT'  => makelink('guild-main-comment&amp;id=' . $news['news_id']),
	'U_EDIT'     => makelink('guild-main-edit&amp;id=' . $news['news_id']),
